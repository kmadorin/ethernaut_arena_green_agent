...
CONFIG = LevelConfig(
    level_id=22,
    name="Dex",
    instance_contract="Dex",
    factory_contract="DexFactory",
    difficulty=3,
    max_turns=30,
    eth_required=0.0,
    extra_tools=[],
    initial_prompt=GAME_TUTORIAL + """=== LEVEL 22: Dex ===
...
""",
    expected_methods=["token1", "token2", "balanceOf", "getSwapPrice", "swap", "approve"]
)
