"""Level 0: Hello Ethernaut configuration."""
...
CONFIG = LevelConfig(
    ...
    factory_contract="InstanceFactory",
    difficulty=0,
    max_turns=30,
    eth_required=0.0,
    extra_tools=[],
    initial_prompt=GAME_TUTORIAL + """=== LEVEL 0: Hello Ethernaut ===
...
""",
    expected_methods=["info", "info1", "info2", "info42", "method7123949", "password", "authenticate"]
)
